...
const Header = () => {
  ...
  return (
      ...
      <header className='w-screen fixed top-0 left-0 border-b-2 border-[--primary] z-10 font-Athiti'  >
        ...
        <div className='bg-[#F7F7F7] md:flex justify-between place-items-center h-20  m-auto px-4'>
        <div className='ml-20'><Logo/></div>
        </div>

        <div className=' hidden sm:flex bg-[--primary] justify-center  place-items-center h-20  m-auto px-4'>
        <ul className='flex justify-between p-0 text-gray-400  mr-20'>
